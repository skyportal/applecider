...
class BaselineCLS(nn.Module):
    ...
    def __init__(self, d_model, n_heads, n_layers, num_classes, dropout, max_len=None, mode=None):
        super().__init__()
    ...
    def forward(self, x, pad_mask):
        ...
        pad = torch.cat([torch.zeros(B, 1, device=torch.device("cuda"), dtype=torch.bool), pad_mask], dim=1)
