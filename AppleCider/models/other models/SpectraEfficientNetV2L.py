...
class SpectraEfficientNetV2L(nn.Module):
    
    def __init__(self, config):
        super(SpectraEfficientNetV2L, self).__init__()
        
        self.dropout_rate = config['s_dropout']
        self.s_dim = config['s_dim']
        
        
        self.backbone = timm.create_model('tf_efficientnetv2_m.in21k_ft_in1k', pretrained=True, num_classes=0)
