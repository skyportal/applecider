...
class AstroMiNN(nn.Module):
    ...
    def __init__(self, config=None, data_sample=None):
        ...
        self.fusion_experts = nn.ModuleList(
            [ResidualTowerBlock(fusion_dims, self.fusion_hidden_dims, 5) for _ in range(self.num_mlp_experts)]
        )
